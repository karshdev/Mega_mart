...
import { addToCart, quantity } from '../redux/cartSlice';
...
const num=useParams()
const res=popularProducts.filter(item=>item.id==num.id)
    ...
    <Container>
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <AddContainer>
            <AmountContainer>
              <RemoveIcon  onClick={()=>fnquantity("remove")} />
              <Amount>{item}</Amount>
              <AddIcon  onClick={()=>fnquantity("add")}/>
            </AmountContainer>
            <Link to="/cart">
